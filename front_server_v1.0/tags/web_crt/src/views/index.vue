  ...
  <div class="indexBox">
    ...
    <div class="stateNumBox">
      ...
      <div class="stateBox">
        <div class="stateImgBox">
          <template v-if="indexData.alarmsNumData.fire != 0">
            <img class="stateImg" src="../assets/img/index/fireImgNZ.svg" alt="" @dragstart.prevent>
          </template>
          <template v-else>
            <img class="stateImg" src="../assets/img/index/fireImg.svg" alt="" @dragstart.prevent>
          </template>
        </div>
      ...
      <div class="stateBox">
        <div class="stateImgBox">
          <template v-if="indexData.alarmsNumData.linkage != 0">
            <img class="stateImg" src="../assets/img/index/startImgNZ.svg" alt="" @dragstart.prevent>
          </template>
          <template v-else>
            <img class="stateImg" src="../assets/img/index/startImg.svg" alt="" @dragstart.prevent>
          </template>
        </div>
      ...
      <div class="stateBox">
        <div class="stateImgBox">
          <template v-if="indexData.alarmsNumData.feedback != 0">
            <img class="stateImg" src="../assets/img/index/feedbackImgNZ.svg" alt="" @dragstart.prevent>
          </template>
          <template v-else>
            <img class="stateImg" src="../assets/img/index/feedbackImg.svg" alt="" @dragstart.prevent>
          </template>
      ...
      <div class="stateBox">
        <div class="stateImgBox">
          <template v-if="indexData.alarmsNumData.malfunction != 0">
            <img class="stateImg" src="../assets/img/index/malfunctionImgNZ.svg" alt="" @dragstart.prevent>
          </template>
          <template v-else>
            <img class="stateImg" src="../assets/img/index/malfunctionImg.svg" alt="" @dragstart.prevent>
          </template>
      ...
      <div class="stateBox">
        <div class="stateImgBox">
          <template v-if="indexData.alarmsNumData.shielding != 0">
            <img class="stateImg" src="../assets/img/index/shieldImgNZ.svg" alt="" @dragstart.prevent>
          </template>
          <template v-else>
            <img class="stateImg" src="../assets/img/index/shieldImg.svg" alt="" @dragstart.prevent>
          </template>
      ...
      <div class="stateBox">
        <div class="stateImgBox">
          <template v-if="indexData.alarmsNumData.supervise != 0">
            <img class="stateImg" src="../assets/img/index/superviseImgNZ.svg" alt="" @dragstart.prevent>
          </template>
          <template v-else>
            <img class="stateImg" src="../assets/img/index/superviseImg.svg" alt="" @dragstart.prevent>
          </template>
      ...
      <div class="alarmsBallBox" @click="showfirst">
        <img class="alarmsBallImg" src="../assets/img/index/alarmsBallImg.svg" alt="" @dragstart.prevent>
      </div>
    </div>
    <!-- 右侧 -->
    <div class="rightBox">
      ...
      <div class="firstAlarmBox" v-show="indexData.firstAlarmState == true">
        <template v-if="indexData.alarmsNumData.all_alarm != 0 && indexData.alarmsNumData.first_fire != 0">
          <div class="firstText">
            <img class="firstIcon" src="../assets/img/comment/firstAlarmsIcon.svg" alt="" @dragstart.prevent>
          </div>
          ...
          <template v-if="indexData.firstAlarmsData.assign_status == 1">
      ...
      <div class="systemDetailBox" v-show="indexData.isActive == 1">
        ...
        <template v-else>
          <template v-if="indexData.objectImgArr.length == 1">
            <img class="objectImg" :src="indexData.objectImg" alt="" @dragstart.prevent>
          </template>
          <template v-else-if="indexData.objectImgArr.length == 0">
            <div class="noneBox">
              <img class="noneImg" src="../assets/img/comment/objectNone.png" alt="" @dragstart.prevent>
            </div>
          </template>
          <template v-else>
            <el-carousel indicator-position="outside">
              <el-carousel-item v-for="item in indexData.objectImgArr" :key="item">
                <img class="objectImg" :src="indexData.url + item.path" alt="" @dragstart.prevent>
              </el-carousel-item>
            </el-carousel>
          </template>
        </template>
      ...
      <div class="projectDetailBox" v-show="indexData.isActive == 2">
        ...
        <template v-else>
          <template v-if="indexData.SystemImgArr.length == 1">
            <img class="objectImg" :src="indexData.SystemImg" alt="" @dragstart.prevent>
          </template>
          <template v-else-if="indexData.SystemImgArr.length == 0">
            <div class="noneBox">
              <img class="noneImg" src="../assets/img/comment/systemNone.png" alt="" @dragstart.prevent>
            </div>
          </template>
          <template v-else>
            <el-carousel indicator-position="outside" :interval="indexData.carouselTime">
              <el-carousel-item v-for="item in indexData.SystemImgArr" :key="item">
                <img class="objectImg" :src="indexData.url + item.path" alt="" @dragstart.prevent>
              </el-carousel-item>
            </el-carousel>
          </template>
      ...
      <div class="planDetailBox" v-show="indexData.isActive == 3">
        ...
        <template v-else>
          <template v-if="indexData.planImgArr.length == 1">
            <img class="objectImg" :src="indexData.planImg" alt="" @dragstart.prevent>
          </template>
          <template v-else-if="indexData.planImgArr.length == 0">
            <div class="noneBox">
              <img class="noneImg" src="../assets/img/comment/plan.png" alt="" @dragstart.prevent>
            </div>
          </template>
          <template v-else>
            <el-carousel indicator-position="outside">
      ...
      <div class="alarmsBox" v-show="Object.keys(indexData.carouselImgId).length > 0">
        ...
        <template v-else>
          <div class="btnBox">
            <div class="topBtn">
              <div class="upBtn" @click="up">
                <img class="IndexBtnIcon" src="../assets/img/index/upIcon.svg" alt="" @click="up" @dragstart.prevent>
              </div>
            </div>
            <div class="centerBtn">
              <div class="upBtn" @click="left">
                <img class="IndexBtnIcon" src="../assets/img/index/leftIcon.svg" alt="" @dragstart.prevent>
              </div>
              <div class="upBtn" @click="move">
                <img class="IndexBtnIcon" src="../assets/img/index/moveIcon.svg" alt="" @dragstart.prevent>
              </div>
              <div class="upBtn" @click="right">
                <img class="IndexBtnIcon" src="../assets/img/index/rightIcon.svg" alt="" @dragstart.prevent>
              </div>
            </div>
            <div class="centerBtn">
              <div class="upBtn" id="butto" @click="big">
                <img class="IndexBtnIcon" src="../assets/img/index/bigIcon.svg" alt="" @dragstart.prevent>
              </div>
              <div class="upBtn" @click="down">
                <img class="IndexBtnIcon" src="../assets/img/index/downIcon.svg" alt="" @dragstart.prevent>
              </div>
              <div class="upBtn" @click="small">
                <img class="IndexBtnIcon" src="../assets/img/index/smallIcon.svg" alt="" @dragstart.prevent>
              </div>
            </div>
          </div>
          <div class="detaildetailMsg" v-if="indexData.deviceDetailShow">
            当前查看设备详情:<br>
            地址:{{ indexData.deviceDetail.device_address }};<br>
            设备类型:{{ indexData.deviceDetail.device_type_name }};<br>
            报警类型:<span style="color: #ff3d3d">
              <span v-if="indexData.deviceDetail.device_status == 2" style="color: #ff3d3d">首警; </span>
              <span v-if="indexData.deviceDetail.fire != 0" style="color: #ff3d3d">火警; </span>
              <span v-if="indexData.deviceDetail.linkage != 0" style="color: #ff3d3d">启动; </span>
              <span v-if="indexData.deviceDetail.feedback != 0" style="color: #ff3d3d">反馈; </span>
              <span v-if="indexData.deviceDetail.malfunction != 0" style="color: orange">故障; </span>
              <span v-if="indexData.deviceDetail.shielding != 0" style="color: orange">屏蔽; </span>
              <span v-if="indexData.deviceDetail.supervise != 0" style="color: #ff3d3d">监管; </span>
              <span v-if="indexData.deviceDetail.vl_malfunction != 0" style="color: orange">声光故障; </span>
              <span v-if="indexData.deviceDetail.vl_shielding != 0" style="color: orange">声光屏蔽; </span>

            </span><br>
            注释:{{ indexData.deviceDetail.description }};
          </div>
          <el-carousel ref="remarkCaruselUp" arrow="never" indicator-position="none" :interval="indexData.carouselTime"
            ...
            <el-carousel-item v-for="(itemid, index) in indexData.carouselImgIdList" :key="index"
              :name="itemid.toString()" :prev="index" :next="index">
              ...
              <template v-else>
                <div class="prevNextBox">
                  <div class="prevBox" @click="prev(index)">
                    <img class="prevImg" src="../assets/img/index/back.svg" alt="" @dragstart.prevent>
                  </div>
                  <div class="nextBox" @click="next(index)">
                    <img class="nextImg" src="../assets/img/index/next.svg" alt="" @dragstart.prevent>
                  </div>
                </div>
              </template>

              <template v-if="indexData.backupsImgIdList[itemid] == 1">
                <div class="imgTitle">
                  {{ indexData.carouselImgId[itemid].area_name }}-{{ indexData.carouselImgId[itemid].build_name }}-{{
                    indexData.carouselImgId[itemid].name
                  }}-平面图
                  {{ index + 1 }}/{{ indexData.carouselImgIdList.length }}
                </div>

                <div class="bigBox" id="bigBox" ref="assingPicRef">
                  <div class="alarmsImgBox" :id="indexData.carouselImgId[itemid].myId">

                    <el-image id="svg1" class="imgbox" :src="indexData.url + indexData.carouselImgId[itemid].path"
                      fit="contain" @dragstart.prevent
                      :style="{ height: indexData.floorItem.height / 192 + 'rem', width: indexData.floorItem.width / 192 + 'rem' }">
                    </el-image>
                    <div class="assign-device" v-for="device in indexData.floorItem.floorAssign" :key="device.id"
                      ...
                      <el-tooltip class="toop-item" effect="dark" placement="top-start" :manual="false"
                        :value="indexData.clickDeviceid.toString() == device.device_id.toString()"
                        v-if="index === indexData.currentFloorIndex">
                        <template #content>
                        ...
                        <el-image :src="indexData.url + device.path" style="user-select:none"
                          :style="{ height: device.height + 'px', width: device.width + 'px' }" @dragstart.prevent>
                        </el-image>
                      </el-tooltip>
                      <!-- 报警状态动画显示 -->
...
<script>
import { onMounted, reactive, watch, ref, nextTick, getCurrentInstance, toRaw, h } from 'vue'
...
import {
  indexStationListRequest, resetAlarmImgRequest
} from "../api/operation";
...
export default {
  ...
  setup() {
    ...
    onMounted(() => {
      ...
      indexData.fs = getComputedStyle(window.document.documentElement)['font-size'].slice(0, -2)
    ...
    const changeImg = (active, val) => {
      ...
      indexData.deviceDetailShow = false
      indexData.deviceDetail = {}
      let keyID = indexData.carouselImgIdList[active]
            ...
            if (indexData.panzoom != null) {
              if (indexData.currentDeviceIndex) {
                ...
                timer = setTimeout(() => {
                  ...
                  indexData.deviceDetail = dd[0]
                  indexData.deviceDetailShow = true
                  let width = proxy.$refs.assingPicRef[0].offsetWidth / 2
                  let height = proxy.$refs.assingPicRef[0].offsetHeight / 2
                  indexData.panzoom.pan((-dd[0].coordinate_X / 192 * indexData.fs + width), (-dd[0].coordinate_Y / 192 * indexData.fs + height))
                  indexData.panzoom.zoomIn({ animate: true })
                  indexData.clickDeviceid = deviceval
                }, 2000)
    ...
    // 监听报警图纸拉取状态 如果轮巡接口数据出现标志位就重新拉取报警数据 拉取图纸信息 在图纸列表不为0时清空标志位
    watch(() => indexData.alarmsNumData, (newvalue, oldvalue) => {
      if (newvalue.is_assign_update == 1) {
        let timerImg = null
        if (indexData.resetImgListState == false) {
          ...
          timerImg = setTimeout(() => {
            ...
            alarmsImgRequest(data).then((res) => {
              ...
              res.data.items.forEach((item, index) => {
                ...
                if (indexData.backupsImgIdList[item.id] == undefined) {
                  ...
                  indexData.carouselImgIdList.push(item.id)
                }
              ...
              bakeArr.forEach((item) => {
                if (list[item.id] == null) {
                  ...
                  // 判断列表id是否存在,存在才能执行删除操作
                  if (indexData.carouselImgIdList.indexOf(item.id) > -1) {
                    indexData.carouselImgIdList.splice(indexData.carouselImgIdList.indexOf(item.id), 1)
                  }
                  // indexData.carouselImgIdList.splice(indexData.carouselImgIdList.indexOf(item.id), 1)
                }
              })
              if (bakeArr.length == 1) {
                if (indexData.floorItem.floorAssign.length == 0) {
                  let timer = null
                  timer = setTimeout(() => {
                ...
                timer = setTimeout(() => {
                  ...
                  if (indexData.lunboindexImg == undefined) {
                    // remarkCaruselUp.value.setActiveItem(indexData.carouselImgIdList[0].toString())
                    indexData.currentFloorIndex = 0
                    changeImg(0)
                    fid()
                  } else {
                    // 多张需要改动 
                    remarkCaruselUp.value.setActiveItem(indexData.carouselImgIdList[indexData.lunboindexImg])
            ...
            indexData.resetImgListState = true
        ...
        if (indexData.alarmsImgList.length != 0) {
          clearTimeout(timerImg)
          timerImg = null
          indexData.resetImgListState = false
          resetAlarmImgRequest().then((res) => {
