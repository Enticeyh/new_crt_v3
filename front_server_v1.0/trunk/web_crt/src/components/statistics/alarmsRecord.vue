            ...
            <div class="selectBox">
                <div class="switchBtnBox">
                    ...
                    <div class="switchBtn" :class="recordData.switchBtnActive == 5 ? 'active' : 'unactive'"
                        @click="switchRecord(5, 1)">屏蔽</div>
                    <div class="switchBtn" :class="recordData.switchBtnActive == 6 ? 'active' : 'unactive'"
                        @click="switchRecord(6, 1)">监管</div>
                    <div class="switchBtn" :class="recordData.switchBtnActive == 7 ? 'active' : 'unactive'"
                        @click="switchRecord(7, 1)">声光故障</div>
                    <div class="switchBtn" :class="recordData.switchBtnActive == 8 ? 'active' : 'unactive'"
                        @click="switchRecord(8, 1)">声光屏蔽</div>
                </div>
                <div class="dateBox">
        ...
        <div class="tableBox">
            <el-table :data="recordData.tableData" class="alarmsTable"
                ...
                <el-table-column prop="device_type_name" label="设备类型" align="center" :show-overflow-tooltip="true"
                    min-width="120%" />
                <el-table-column prop="alarm_type_name" label="报警类型" align="center" :show-overflow-tooltip="true"
                    min-width="60%" />
                <el-table-column prop="alarm_status" label="报警状态" align="center" :show-overflow-tooltip="true"
                    min-width="60%" :formatter="formatState" />
            ...
            <div class="moreSelectBox" v-show="recordData.moreSelect">
                ...
                <div class="sureBtnBox">
                    <div class="sureBtn" @click="moreSelect"> <img src="../../assets/img/comment/searchImg.svg" alt=""
                            @dragstart.prevent>&nbsp; 查询</div>
                </div>
            </div>
        </div>
...
export default {
    ...
    setup(props) {
        ...
        watch(props, (newProps) => {
            ...
            if (recordData.propsRecordType == 1) {
                recordData.requestObject.alarm_type_id = 0
            } else {
                recordData.requestObject.alarm_type_id = ""
            }
