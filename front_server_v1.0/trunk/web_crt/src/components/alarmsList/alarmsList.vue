    ...
    <div class="alarmsList" v-show="alarmsListShow" v-loading="alarmsListData.loading">
        ...
        <div class="listTitleBox">
            <div class="alarmsTypeSelectBox">
                ...
                <div class="selectBtn" :class="alarmsListData.isActive == 3 ? 'active' : 'unactive'"
                    @click="alarmsTypeSelect(3)">反馈</div>
                <div class="selectBtn" :class="alarmsListData.isActive == 4 ? 'active' : 'unactive'"
                    @click="alarmsTypeSelect(4)">故障</div>
                <div class="selectBtn" :class="alarmsListData.isActive == 5 ? 'active' : 'unactive'"
                    @click="alarmsTypeSelect(5)">屏蔽</div>
                <div class="selectBtn" :class="alarmsListData.isActive == 6 ? 'active' : 'unactive'"
                    @click="alarmsTypeSelect(6)">监管</div>
                <div class="selectBtn" :class="alarmsListData.isActive == 7 ? 'active' : 'unactive'"
                    @click="alarmsTypeSelect(7)">声光故障</div>
                <div class="selectBtn" :class="alarmsListData.isActive == 8 ? 'active' : 'unactive'"
                    @click="alarmsTypeSelect(8)">声光屏蔽</div>
            </div>
