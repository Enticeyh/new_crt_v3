...
<template>
  <div class="indexBox">
    ...
    <div class="stateNumBox">
      ...
      <div class="stateBox">
        <div class="stateImgBox">
          <template v-if="indexData.alarmsNumData.forced_light_on != 0">
            <img class="stateImg" src="../assets/img/index/constraintNZ.svg" alt="" @dragstart.prevent>
          </template>
          <template v-else>
            <img class="stateImg" src="../assets/img/index/constraint.svg" alt="" @dragstart.prevent>
          </template>

        </div>
        <div class="stateText">强点</div>
        <div class="stateNum">
          <template v-if="indexData.alarmsNumData.forced_light_on == undefined">
            <!-- 0 -->
          </template>
          <template v-else>
            <!-- {{ indexData.alarmsNumData.forced_light_on }} -->
          </template>
        </div>
      </div>
      <!-- 强制应急 -->
      <div class="stateBox">
        <div class="stateImgBox">
          <template v-if="indexData.alarmsNumData.forced_emergency != 0">
        ...
        <div class="stateText">强制应急</div>
        <div class="stateNum">
          <template v-if="indexData.alarmsNumData.forced_emergency == undefined">
            <!-- 0 -->
          </template>
          <template v-else>
            <!-- {{ indexData.alarmsNumData.forced_emergency }} -->
          </template>
      ...
      <div class="stateBox">
        <div class="stateImgBox">
          <template v-if="indexData.alarmsNumData.contingency_plan != 0">
        ...
        <div class="stateText">预案启动</div>
        <div class="stateNum">

          <template v-if="indexData.alarmsNumData.contingency_plan == undefined">
            <!-- 0 -->
          </template>
          <template v-else>
            <!-- {{ indexData.alarmsNumData.contingency_plan }} -->
          </template>
        </div>
      </div>
      <!-- 火警球 -->
      ...
      <div class="alarmsBox" v-show="Object.keys(indexData.carouselImgId).length > 0">
        ...
        <template v-else>
          ...
          <div class="detaildetailMsg" v-if="indexData.deviceDetailShow">
                  地址:{{indexData.deviceDetail.device_address}};
                  设备类型:{{indexData.deviceDetail.device_type_name}};
                  报警类型:<span style="color: #ff3d3d">
                      <span v-if="indexData.deviceDetail.device_status == 2" style="color: #ff3d3d">首警; </span>
                          ...
                          <span v-if="indexData.deviceDetail.forced_light_on != 0" style="color: #ff3d3d">强点; </span>
                          <span v-if="indexData.deviceDetail.forced_emergency != 0" style="color: #ff3d3d">强制应急; </span>
                    ...
                    <div class="assign-device" v-for="device in indexData.floorItem.floorAssign" :key="device.id"
                      ...
                      <el-tooltip class="toop-item" effect="dark" placement="top-start" :manual="false"
                        ...
                        <template #content>
                          ...
                          <span v-if="device.forced_light_on != 0" style="color: #ff3d3d">强点; </span>
                          <span v-if="device.forced_emergency != 0" style="color: #ff3d3d">强制应急; </span>
                      ...
                      <div v-if="device.alarm != 0">
                        ...
                        <div class="circle"
                          v-else-if="device.fire != 0 || device.linkage != 0 || device.forced_light_on != 0 || device.forced_emergency != 0">
                          <div class="circle1"></div>
                          <div class="circle2"></div>
                          <div class="circle3"></div>
                        </div>
                        <div class="launch_circle"
                          v-else-if="device.malfunction != 0">
