...
class Config:
    ...
    # 智慧消防相关地址
    CENTER_TEST_URL = "http://%s:%s/te-0/v1/testEvents"  # 测试接口
    CENTER_HEART_URL = "http://%s:%s/te-0/v1/heartbeatEvents"  # 心跳接口
...
class BaseConfig(Config):
    ...
    MYSQL_URL = 'mysql+aiomysql://root:123456@127.0.0.1:13306/new_crt'
    # MYSQL_URL = 'mysql+aiomysql://root:123456@112.124.25.173:13306/new_crt_tags'
